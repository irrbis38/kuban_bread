...
var initHeaderMenu=()=>{var t=document.body,r=document.querySelector(".header__burger_btn"),a=document.querySelector(".header__nav");t&&r&&a?(r.addEventListener("click",function(){t.classList.toggle("lock"),r.classList.toggle("active"),a.classList.toggle("active")}),window.matchMedia("(max-width: 1300px)").addEventListener("change",e=>{e.matches||(t.classList.remove("lock"),r.classList.remove("active"),a.classList.remove("active"))})):console.error("Could not find element(s) for header menu initialization")},initIntroSlider=()=>{new Swiper(".intro__slider",{loop:!0,slidesPerView:1,spaceBetween:0,pagination:{el:".intro__paggination",clickable:!0},autoplay:!0})},initChangeLang=()=>{var t=document.querySelector(".header__lang"),r=document.querySelector(".header__switch_lang"),e=document.querySelectorAll(".header__label");t.addEventListener("click",()=>{r.classList.toggle("active")}),window.addEventListener("click",e=>{e.target.closest(".header__lang_wrapper")||r.classList.remove("active")}),e.forEach(e=>{e.addEventListener("click",()=>{r.classList.remove("active"),t.children[0].textContent=e.dataset.lang})})},doCreateMapScript=t=>{setTimeout(function(){var e=document.createElement("script");e.async=!1,e.src="https://api-maps.yandex.ru/2.1/?apikey=key&lang=ru_RU",document.body.appendChild(e),e.onload=()=>t()},2e3)},initMap=()=>{ymaps.ready(()=>{var e,t=[45.051405,39.00608];ymaps&&(e=new ymaps.Map("contacts-map",{center:t,zoom:17}),t=new ymaps.Placemark(t,{},{iconLayout:"default#image",iconImageHref:"images/mark.svg",iconImageSize:[100,100],iconImageOffset:[-60,-80]}),e.controls.remove("geolocationControl"),e.controls.remove("searchControl"),e.controls.remove("trafficControl"),e.controls.remove("typeSelector"),e.controls.remove("fullscreenControl"),e.controls.remove("rulerControl"),e.geoObjects.add(t))})},initForms=()=>{var e=Array.from(document.forms),o=document.querySelector(".msg"),n=document.body,t=Array.from(document.querySelectorAll(".msg__close"));e.forEach(r=>{var a=Array.from(r.elements).filter(e=>e.required);a.forEach(e=>e.addEventListener("input",()=>e.classList.remove("error"))),r.addEventListener("submit",e=>{var t;e.preventDefault(),e=r,(t=a).forEach(e=>{e.classList.contains("input-phone")&&e.value.length<10&&e.classList.add("error")}),t.some(e=>e.classList.contains("error"))||(e.reset(),o.classList.add("active"),n.classList.add("lock"))})}),t.forEach(e=>e.addEventListener("click",()=>{o.classList.remove("active"),n.classList.remove("lock")}))},initYoutubeVideo=e=>{e.forEach(r=>{var e=r.dataset.video,a=e.substring("https://youtu.be/".length,e.length),o=r.parentElement;o.querySelector(".video-play-btn").addEventListener("click",()=>{t=a,(e=document.createElement("iframe")).classList.add("video-iframe"),e.setAttribute("src","https://www.youtube.com/embed/"+t+"?rel=0&showinfo=0&autoplay=1"),e.setAttribute("title","YouTube video player"),e.setAttribute("frameborder","0"),e.setAttribute("allowfullscreen",""),e.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;");var e,t=e;o.querySelector(".video-preview").remove(),r.append(t)})})},initMaskaInput=()=>{var e=Maska["MaskInput"];new e("[data-maska]")},initModal=(e,t)=>{var r=t.querySelector(".fullscreen__img img"),a=t.querySelectorAll(".fullscreen-close"),o=document.body;a.forEach(e=>{e.addEventListener("click",()=>{t.classList.remove("show"),o.classList.remove("lock")})}),e.forEach(e=>{e.addEventListener("click",()=>{console.log(e.dataset.src),r.src=e.dataset.src,t.classList.add("show"),o.classList.add("lock")})})};document.addEventListener("DOMContentLoaded",()=>{initHeaderMenu(),initIntroSlider(),initChangeLang(),document.getElementById("contacts-map")&&doCreateMapScript(initMap);0<document.forms.length&&initForms();var e=Array.from(document.querySelectorAll(".video-block"));0<e.length&&initYoutubeVideo(e);document.querySelectorAll("[data-maska]")&&initMaskaInput();var e=document.querySelectorAll(".modal-open"),t=(console.log(e),document.querySelector(".fullscreen"));0<e.length&&t&&initModal(e,t)});